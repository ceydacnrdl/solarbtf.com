<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatteryVoltage.aspx.cs" Inherits="_2209ASolarBTF.BatteryVoltage" %>
...
<header class="navbar navbar-dark sticky-top bg-dark8 flex-md-nowrap p-0 shadow">
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <asp:LinkButton ID="LinkButton5" runat="server" class="nav-link" data-bs-target="#nav-home" role="tab" aria-controls="nav-home"  OnClick="LinkButton5_Click">1Y</asp:LinkButton>
        ...
        <asp:TextBox ID="Date1" runat="server" type="date" text="" OnTextChanged="Date1_TextChanged"></asp:TextBox>
        <asp:TextBox ID="Date2" runat="server" type="date" OnTextChanged="Date2_TextChanged"></asp:TextBox>
 ...
 <script>
     const myChartFiltered = new Chart(document.getElementById('myChartFiltered'), config2);
       ...
       <asp:LinkButton ID="LinkButtonExport" runat="server" Font-Bold="True" Font-Size="Medium" OnClick="LinkButtonExport_Click">Export To Excel</asp:LinkButton>
