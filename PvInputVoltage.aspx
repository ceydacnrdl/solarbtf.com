<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PvInputVoltage.aspx.cs" Inherits="_2209ASolarBTF.PvInputVoltage" %>
...
<header class="navbar navbar-dark sticky-top bg-dark8 flex-md-nowrap p-0 shadow">
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <asp:TextBox ID="Date1" runat="server" type="date"></asp:TextBox>
        ...
        <asp:CheckBox ID="CheckBox1" runat="server" Text="Outlier Analysis" />
        ...
        <table class="table table-striped table-sm">
          <tbody>
              ...
              <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-condensed table-responsive table-hover "
                  ...
                  <asp:BoundField DataField="pv_input_voltage" HeaderText="PV Input Voltage" />
